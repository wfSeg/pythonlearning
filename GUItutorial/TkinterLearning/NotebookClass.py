...
class notebook:
    ...
    # creates notebooks' frames structure
    ...
    def add_screen(self, fr, title):
        ...
        #returns a reference to the newly created radiobutton
        #(allowing its configuration/desctruction)
        return b
    
    #hides the former active frame and shows another one, 
