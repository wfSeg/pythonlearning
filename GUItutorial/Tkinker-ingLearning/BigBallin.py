...
#Canvas
baller=Tk()
canvas = Canvas(baller, width=200, height=200)
canvas.pack()
...
entry1label_window = canvas.create_window(-40, 20, anchor=NW, window=entry1label)
entry1entry = Entry(baller, bd = 5)
entry1entry.pack(side = RIGHT)
entry1entry.focus_set()
entry1entry_window = canvas.create_window(60, 20, anchor=NW, window=entry1entry)
...
entry2label_window = canvas.create_window(-40, 60, anchor=NW, window=entry2label)
entry2entry = Entry(baller, bd = 5)
entry2entry.pack(side = RIGHT)
entry2entry_window = canvas.create_window(60, 60, anchor=NW, window=entry2entry)
...
entry3label_window = canvas.create_window(-40, 100, anchor=NW, window=entry3label)
entry3entry = Entry(baller, bd = 5)
entry3entry.pack(side = RIGHT)
entry3entry_window = canvas.create_window(60, 100, anchor=NW, window=entry3entry)
print (entry3label.winfo_geometry())
print (entry3entry.winfo_geometry())

#"i got no scripts" box
def Placeholder():
    tkMessageBox.showinfo("Ballin'", "Sorry, We're All Sold Out!\nCheck back again later")
   
button1 = Button(text = "BIOS Scripts", command = Placeholder)
button1.configure(width = 0,
                  activebackground = "Yellow",
                  relief = GROOVE)
button1_window = canvas.create_window(-60, 140, anchor=NW, window=button1)
button1.update()
print (button1.winfo_geometry())

button2 = Button(text = "IPMI Scripts", command = Placeholder)
button2.configure(width = 0,
                  activebackground = "Yellow",
                  relief = GROOVE)
button2_window = canvas.create_window(20, 140, anchor=NW, window=button2)
button2.update()
print (button2.winfo_geometry())

button3 = Button(text = "Other Scripts", command = Placeholder)
button3.configure(width = 0,
                  activebackground = "Yellow",
                  relief = GROOVE)
button3_window = canvas.create_window(100, 140, anchor=NW, window=button3)
button3.update()
...
button4.configure(width = 0,
                  activebackground = "Yellow",
                  relief = GROOVE)
button4_window = canvas.create_window(-60, 180, anchor=NW, window=button4)
button4.update()
print (button3.winfo_geometry())
